...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Server" Type="Folder">
			<Item Name="Form Server.lvlib" Type="Library" URL="../Form Server.lvlib"/>
		...
		<Item Name="Control" Type="Folder">
			...
			<Item Name="Forms.lvlib" Type="Library" URL="../Forms.lvlib"/>
		</Item>
		<Item Name="Launch Actors.vi" Type="VI" URL="../Launch Actors.vi"/>
		<Item Name="get table and column names.vi" Type="VI" URL="../../source/Utility/get table and column names.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Database.lvclass" Type="LVClass" URL="../../source/Database/Database.lvclass"/>
			<Item Name="foreign key properties.ctl" Type="VI" URL="../../source/foreign key properties.ctl"/>
			<Item Name="LV Config Read String.vi" Type="VI" URL="/&lt;resource&gt;/dialog/lvconfig.llb/LV Config Read String.vi"/>
			<Item Name="systemLogging.dll" Type="Document" URL="systemLogging.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Field.lvclass" Type="LVClass" URL="../../source/Field/Field.lvclass"/>
			<Item Name="Ring Field.lvclass" Type="LVClass" URL="../../source/Ring Field/Ring Field.lvclass"/>
			<Item Name="String and values individual array to cluster array.vi" Type="VI" URL="../../source/String and values individual array to cluster array.vi"/>
			<Item Name="String and values cluster array to individual array.vi" Type="VI" URL="../../source/String and values cluster array to individual array.vi"/>
			<Item Name="Text field.lvclass" Type="LVClass" URL="../../source/Test field/Text field.lvclass"/>
			<Item Name="Numeric Field.lvclass" Type="LVClass" URL="../../source/Numeric Field/Numeric Field.lvclass"/>
			<Item Name="FK Ring.lvclass" Type="LVClass" URL="../../source/FK Ring/FK Ring.lvclass"/>
			<Item Name="Match Pattern in Column Name Array.vi" Type="VI" URL="../../source/Match Pattern in Column Name Array.vi"/>
			<Item Name="FK Ring Info.ctl" Type="VI" URL="../../source/FK Ring/FK Ring Info.ctl"/>
			<Item Name="FK Ring Field Info.ctl" Type="VI" URL="../../source/Field/FK Ring Field Info.ctl"/>
			<Item Name="Numeric Field Info.ctl" Type="VI" URL="../../source/Field/Numeric Field Info.ctl"/>
			<Item Name="Ring Field Info.ctl" Type="VI" URL="../../source/Field/Ring Field Info.ctl"/>
			<Item Name="Text Field Info.ctl" Type="VI" URL="../../source/Field/Text Field Info.ctl"/>
			<Item Name="ADODB.lvclass" Type="LVClass" URL="../../source/ODBC/ADODB.lvclass"/>
			<Item Name="recordset get field names.vi" Type="VI" URL="../../source/recordset get field names.vi"/>
			<Item Name="connection open schema.vi" Type="VI" URL="../../source/connection open schema.vi"/>
			<Item Name="Button.lvclass" Type="LVClass" URL="../../source/Button/Button.lvclass"/>
			<Item Name="Open Form.lvclass" Type="LVClass" URL="../../source/Open Form/Open Form.lvclass"/>
		</Item>
