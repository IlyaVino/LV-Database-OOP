	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Table OOP" Type="Folder">
			...
			<Item Name="Column" Type="Folder">
				...
				<Item Name="Basic Field Constructors.lvlib" Type="Library" URL="../Column Libraries/Basic Field Constructors.lvlib"/>
			</Item>
		...
		<Item Name="sketches" Type="Folder">
			...
			<Item Name="top level vi form database ideas.vi" Type="VI" URL="../../../unit tests/top level vi form database ideas.vi"/>
			<Item Name="table column sketch.vi" Type="VI" URL="../../../unit tests/table column sketch.vi"/>
		</Item>
		<Item Name="Must Call Child Method.vi" Type="VI" URL="../Error Handler/Must Call Child Method.vi"/>
