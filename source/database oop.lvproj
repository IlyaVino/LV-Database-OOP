...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Database OOP" Type="Folder">
			<Item Name="ADODB.lvclass" Type="LVClass" URL="../ODBC/ADODB.lvclass"/>
		...
		<Item Name="Form OOP" Type="Folder">
			<Item Name="Field OOP" Type="Folder">
				<Item Name="Field.lvclass" Type="LVClass" URL="../Field/Field.lvclass"/>
				<Item Name="Text field.lvclass" Type="LVClass" URL="../Test field/Text field.lvclass"/>
				<Item Name="Numeric Field.lvclass" Type="LVClass" URL="../Numeric Field/Numeric Field.lvclass"/>
		...
		<Item Name="ADODB subVIs" Type="Folder">
			<Item Name="connection open schema.vi" Type="VI" URL="../connection open schema.vi"/>
			<Item Name="recordset get field names.vi" Type="VI" URL="../recordset get field names.vi"/>
		</Item>
		<Item Name="Ring subVIs" Type="Folder">
			<Item Name="String and values cluster array to individual array.vi" Type="VI" URL="../String and values cluster array to individual array.vi"/>
			<Item Name="String and values individual array to cluster array.vi" Type="VI" URL="../String and values individual array to cluster array.vi"/>
		</Item>
		<Item Name="foreign key properties.ctl" Type="VI" URL="../foreign key properties.ctl"/>
		<Item Name="Build Method.ctl" Type="VI" URL="../Field/Build Method.ctl"/>
