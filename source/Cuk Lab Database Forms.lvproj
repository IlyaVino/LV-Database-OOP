...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Database OOP" Type="Folder">
			<Item Name="Button Libraries" Type="Folder">
				<Item Name="Button Interfaces.lvlib" Type="Library" URL="../Database OOP/Button Libraries/Button Interfaces.lvlib"/>
			...
			<Item Name="Database Libraries" Type="Folder">
				<Item Name="Utility" Type="Folder">
					<Item Name="database reuse unit tests.vi" Type="VI" URL="../Database OOP/Database Libraries/Database Reuse/database reuse unit tests.vi"/>
					<Item Name="MS Access Reserved Words Set Builder.vi" Type="VI" URL="../Database OOP/Database Libraries/MS Access Database Engine/MS Access Reserved Words Set Builder.vi"/>
				</Item>
				<Item Name="ADODB.lvlib" Type="Library" URL="../Database OOP/Database Libraries/ADODB.lvlib"/>
				<Item Name="Database Interfaces.lvlib" Type="Library" URL="../Database OOP/Database Libraries/Database Interfaces.lvlib"/>
				<Item Name="Database Reuse.lvlib" Type="Library" URL="../Database OOP/Database Libraries/Database Reuse.lvlib"/>
			</Item>
			<Item Name="Error Handler" Type="Folder">
				<Item Name="Must Call Child Method.vi" Type="VI" URL="../Database OOP/Error Handler/Must Call Child Method.vi"/>
			</Item>
			<Item Name="Table Libraries" Type="Folder">
				<Item Name="Form.lvlib" Type="Library" URL="../Database OOP/Table Libraries/Form.lvlib"/>
				<Item Name="Table.lvlib" Type="Library" URL="../Database OOP/Table Libraries/Table.lvlib"/>
			</Item>
		</Item>
		<Item Name="Forms AF" Type="Folder">
			...
			<Item Name="Forms Model" Type="Folder">
				<Item Name="Form Model Interfaces.lvlib" Type="Library" URL="../Forms AF/Forms Model/Form Model Interfaces.lvlib"/>
				<Item Name="Form Model.lvlib" Type="Library" URL="../Forms AF/Forms Model/Form Model.lvlib"/>
			</Item>
			<Item Name="Forms Server" Type="Folder">
				<Item Name="Form Server Interfaces.lvlib" Type="Library" URL="../Forms AF/Forms Server/Form Server Interfaces.lvlib"/>
				<Item Name="Form Server.lvlib" Type="Library" URL="../Forms AF/Forms Server/Form Server.lvlib"/>
