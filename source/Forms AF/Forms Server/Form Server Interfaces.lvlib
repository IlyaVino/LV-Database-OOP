...
<Library LVVersion="20008000">
	<Property Name="NI.Lib.Description" Type="Str">This library defines the messages for the form server actor, along with typeDefs required to identify forms UIs and form components.</Property>
	...
	<Item Name="Form ID.ctl" Type="VI" URL="../Autoclose manager/Form ID.ctl"/>
	<Item Name="Form Server Messages.lvclass" Type="LVClass" URL="../Form Server Messages/Form Server Messages.lvclass"/>
	<Item Name="Open Close Logic.lvclass" Type="LVClass" URL="../Autoclose manager/Open Close Logic.lvclass"/>
